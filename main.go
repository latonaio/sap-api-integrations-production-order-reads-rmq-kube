...
import (
	sap_api_caller "sap-api-integrations-production-order-reads-rmq-kube/SAP_API_Caller"
	sap_api_input_reader "sap-api-integrations-production-order-reads-rmq-kube/SAP_API_Input_Reader"
	"sap-api-integrations-production-order-reads-rmq-kube/config"
...
func callProcess(caller *sap_api_caller.SAPAPICaller, msg rabbitmq.RabbitmqMessage) (err error) {
	...
	caller.AsyncGetProductionOrder(manufacturingOrder, accepter)
	return nil
}
